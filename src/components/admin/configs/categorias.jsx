  ...
  return (
    <>
      <article className="w-full px-2">
        <div className="flex flex-col gap-4 justify-center px-5 py-6 shadow-sm rounded-[20px] bg-black border-2 border-black">
          <div className="flex justify-between   ">
            <h1 className="text-white text-lg uppercase text-left font-bold font-commuter">
              Categorias
            </h1>
            <button
              className="rounded-[10px] shadow-md px-2 py-1 font-bold bg-primary text-white transition-colors"
              onClick={handleOpen}
            >
              + AGREGAR NUEVO
            </button>
        ...
        <Box sx={style}>
          ...
          <form onSubmit={addCateg} className="pt-4">
            <div className="grid grid-cols-1 w-full">
              ...
              <input
                className="px-3 h-10 rounded-lg border-2 border-black mt-1 focus:border-primary-600  outline-none"
                id={name}
                type="text"
                value={name}
            ...
            <div className="w-full text-center pt-6">
              <input
                className="px-8 py-1 bg-primary rounded-xl font-bold text-white cursor-pointer w-full"
                type="submit"
                value="Confirmar"
              />
            </div>
